...
export const FEATURE_TOUR_KEY = "@blade_has_seen_feature_tour";
...
const SLIDES: Slide[] = [
  {
    ...
    subtitle:
      "Your outboard's complete identity. Add to Apple Wallet, Google Wallet, or download as PDF.",
  ...
  },
  {
    ...
    subtitle:
      "Connect wirelessly to your outboard for real-time telemetry, diagnostics, and control.",
  ...
  },
  {
    ...
    subtitle:
      "GPS location tracking even when powered off. Know where your outboard is at all times.",
  ...
  },
  {
    ...
    subtitle:
      "Automatically log every journey with telemetry data. Export and share detailed PDF reports.",
  ...
  },
  {
    ...
    subtitle:
      "Receive the latest firmware and features delivered wirelessly to your outboard.",
...
function AnimatedIcon({
  ...
  return (
    <Animated.View style={[styles.iconCircle, iconStyle]}>
      <Feather name={name} size={80} color="rgba(255,255,255,0.9)" />
    </Animated.View>
  );
}
  ...
  return (
    <View style={styles.slide}>
      <Animated.View style={[styles.animationContainer, animContainerStyle]}>
        <AnimatedIcon name={slide.icon} isActive={isActive} />
      </Animated.View>
...
export default function FeatureTourScreen({ onComplete }: FeatureTourScreenProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing["2xl"] }]}>
        <Pressable
          ...
          testID={isLastSlide ? "feature-tour-explore" : "feature-tour-next"}
        >
          <LinearGradient
