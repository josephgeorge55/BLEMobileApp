...
export function createExtendedTripFromBasic(
  ...
  return {
    ...
    userEmail: basicTrip.userEmail || userEmail,
    userFirestoreId: basicTrip.userFirestoreId || null,
    ...
    maxAmperageDraw: basicTrip.maxAmperageDraw || 0,
    maxConsumptionKW: basicTrip.maxConsumptionKW || 0,
    avgConsumptionKW: basicTrip.avgConsumptionKW || 0,
    rpmMax: basicTrip.rpmMax || 0,
    rpmAvg: basicTrip.rpmAvg || 0,
    
    connectionType: basicTrip.connectionType || 'Demo',
    
    dataPoints,
    
    odometerStartKm: basicTrip.odometerStartKm || 0,
    odometerEndKm: basicTrip.odometerEndKm || basicTrip.totalDistanceKm || 0,
    
    firmwareVersion: basicTrip.firmwareVersion || null,
    hardwareVersion: 'H32026',
    phoneAppVersion: basicTrip.phoneAppVersion || Constants.expoConfig?.version || '1.0.0',
    phoneName: basicTrip.phoneName || Device.deviceName || null,
    phoneDeviceType: basicTrip.phoneDeviceType || (Device.deviceType ? String(Device.deviceType) : null),
    phoneOS: basicTrip.phoneOS || `${Platform.OS} ${Platform.Version}`,
